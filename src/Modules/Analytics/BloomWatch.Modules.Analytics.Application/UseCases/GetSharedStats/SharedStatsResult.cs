...
/// <param name="TotalWatchSessions">Total number of watch sessions recorded in the watch space.</param>
/// <param name="MostRecentSessionDate">The date of the most recent watch session, or <c>null</c> if no sessions have been recorded.</param>
