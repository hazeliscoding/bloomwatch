...
The system SHALL display a settings panel within the watch space detail page at `/watch-spaces/:id`. The panel SHALL be visible to all members of the watch space.
